...
func NewFileProcessor(cfg *config.Config) *FileProcessor {
	...
	return &FileProcessor{
		decompressor: NewDecompressor(decompressorConfig),
		config:       cfg,
	}
}

func (fp *FileProcessor) ProcessJob(ctx context.Context, job *Job) JobResult {
	startTime := time.Now()
...
func (fp *FileProcessor) downloadFileFromMinIO(ctx context.Context, job *Job) (string, error) {
...
func (fp *FileProcessor) processExtractedFiles(ctx context.Context, job *Job, extractedFiles []string) error {
...
func (fp *FileProcessor) processSingleFile(ctx context.Context, job *Job, filePath string) error {
...
func (fp *FileProcessor) uploadProcessedResults(ctx context.Context, job *Job, result JobResult) error {
